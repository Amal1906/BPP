...
export class DataService {
   ...
   */
  getProcessStatus(start_date: string, end_date: string): Observable<any> {
 ...
 * @param {object} payload - Process details (process_type + date)
 * @returns {Observable<any>}
 */
  // data.service.ts
triggerBot1(process_type: string) {
  return this.http.get<any>(`trigger_bot_1`, {
    params: { process_type }
  });
}
